# Script para generar los datos correctos de tanques para App.tsx
...
print("const tankData: Record<string, TankData> = {")
for tank_id, data in tank_data.items():
    print(f'  "{tank_id}": {{ "GALS_PER_INCH": {data["GALS_PER_INCH"]}, "GALS_IN_TOP": {data["GALS_IN_TOP"]}, "TOP_INCHES": {data["TOP_INCHES"]}, "TOTAL_GALS": {data["TOTAL_GALS"]} }},')
print("};")
print(f"\n// Total: {len(tank_data)} tanques")
